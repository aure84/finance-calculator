export default function PrivacyPage() {
  ...
  return (
    <main style={{ maxWidth: 760, margin: '0 auto', padding: '40px 24px' }}>
      ...
      <p style={s}>
        We do not collect your name, email address, or the values you enter into calculators.
        The following data is collected automatically when you visit the site:
      </p>
      ...
      <h2 style={h2}>3. Legal Basis for Processing (GDPR Art. 6)</h2>
      ...
      <h2 id="ccpa" style={h2}>6. Your Rights</h2>
      <p style={s}>
