...
export const STATES: StateInfo[] = [
  ...
  { id: 'CA', name: 'California', brackets: [{ min: 0, max: 10756, rate: 0.01 }, { min: 10756, max: 25499, rate: 0.02 }, { min: 25499, max: 40245, rate: 0.04 }, { min: 40245, max: 55866, rate: 0.06 }, { min: 55866, max: 70606, rate: 0.08 }, { min: 70606, max: 360659, rate: 0.093 }, { min: 360659, max: 432787, rate: 0.103 }, { min: 432787, max: 721315, rate: 0.113 }, { min: 721315, max: 1000000, rate: 0.123 }, { min: 1000000, max: Infinity, rate: 0.133 }] },
  ...
  { id: 'MA', name: 'Massachusetts', brackets: [{ min: 0, max: 1053750, rate: 0.05 }, { min: 1053750, max: Infinity, rate: 0.09 }] },
