      ...
      <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', marginBottom: 24 }}>
        <div>
          ...
          <input type="number" value={principal} onChange={e => setPrincipal(e.target.value)} placeholder="10000"
            style={{ padding: '10px 12px', border: '1px solid var(--border)', borderRadius: 6, fontSize: 16, width: 180, height: 43, boxSizing: 'border-box' }} />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="number" value={years} onChange={e => setYears(e.target.value)} placeholder="10"
            style={{ padding: '10px 12px', border: '1px solid var(--border)', borderRadius: 6, fontSize: 16, width: 120, height: 43, boxSizing: 'border-box' }} />
        </div>
        <div>
          <label style={{ display: 'block', fontSize: 14, marginBottom: 6 }}>Compounding</label>
          <select value={frequency} onChange={e => setFrequency(e.target.value)}
            style={{ padding: '10px 12px', border: '1px solid var(--border)', borderRadius: 6, fontSize: 16, width: 140, height: 43, boxSizing: 'border-box' }}>
